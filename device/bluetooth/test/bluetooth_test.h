...
class BluetoothTestBase : public testing::Test {
 public:
  ...
  // Remembers |characteristic| platform specific object or identifier to be
  // used in a subsiquent call to methods such as SimulateGattCharacteristicRead
  // that accept a nullptr value to select this remembered characteristic.
  // This enables tests where the platform attempts to reference characteristic
